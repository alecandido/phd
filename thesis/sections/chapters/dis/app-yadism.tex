...
\begin{figure}[!t]
 ...
 \caption{Comparison of the {\sc\small YADISM} predictions for DIS structure functions
   and reduced cross-sections
   at NNLO with the corresponding ones from {\sc\small APFEL} for the same choice of input settings.
   %
