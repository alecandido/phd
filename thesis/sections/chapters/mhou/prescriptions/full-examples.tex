...
\begin{figure}
    ...
    \centering
        $\vcenter{\hbox{\input{sections/chapters/mhou/prescriptions/derivation/9}}}$
    \qquad
...
\begin{figure}
    ...
    \centering
        $\vcenter{\hbox{\input{sections/chapters/mhou/prescriptions/derivation/5}}}$
    \qquad
...
\begin{figure}
    ...
    \centering
        $\vcenter{\hbox{\input{sections/chapters/mhou/prescriptions/derivation/5bar}}}$
    \qquad
