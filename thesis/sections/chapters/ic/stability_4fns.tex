...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  on \nnpdfr{4.0} with that obtained
  from the same input dataset but using instead
  the \nnpdfr{3.1} fitting methodology and related settings such those related to positivity
  and integrability.
  %
...
\begin{figure}[t]
  \begin{center}
    ...
    \caption{\small Same as \cref{fig:ic/charm_basisdep}, comparing
      the baseline determination of the 4\fns charm \pdf, based
      on \nnpdfr{4.0}, with that obtained
      from the same dataset using the \nnpdfr{3.1} fitting methodology.
