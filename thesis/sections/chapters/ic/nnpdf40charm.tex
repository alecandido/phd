...
Our starting point is the \nnpdfr{4.0} global analysis, \cite{Ball:2021leu}, which
...
We emphasize that in our analysis the charm \pdf is entirely determined by the
  ...
  \begin{center}
    \includegraphics[width=0.99\linewidth]{ch-ic/Fig2.pdf}
     \caption{\small
        ...
        GeV in \nnpdfr{4.0} and the \lhcb measurements of $\mathcal{R}_j^c$  for the
        three $y_Z$ bins.
        %
