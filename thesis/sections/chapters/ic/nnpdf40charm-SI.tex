...
%In this Supplementary Information, references that already appear in the main manuscript
%use the same number, and new references are provided at the end of the document.
...
code~\citesupp{NNPDF:2021uiq} and it is performed here by means of a novel code
for QCD evolution, 
...
APFEL}~\citesupp{Bertone:2013vaa} evolution code that is used by the
NNPDF code.
...
\end{center}
as well as in a dedicated publication~\citesupp{Candido:2022tld}.
...
%
This is the strategy adopted by, among others, the  {\sc\small APFEL}~\citesupp{Bertone:2013vaa},
{\sc\small HOPPET}~\citesupp{Salam:2008qg},
and {\sc\small QCDNUM}~\citesupp{Botje:2010ay} evolution codes.
%
...
%
This approach is adopted by {\sc\small PEGASUS}~\citesupp{pegasus} as well as by the
internal PDF evolution code {\sc\small FastKernel} used in earlier NNPDF analyses
and described in~\citesupp{DelDebbio:2007ee,Ball:2008by,Ball:2010de}.
%
...
This restriction is bypassed in {\sc\small FastKernel} by transforming only the
...
\be
\label{eq:ic/EKO2}
{\mathbf{f}}^{(n_f+1)}(Q^2_1)= \lc {\mathbf{E}}^{(n_f+1)}(Q^2_1\leftarrow Q_{h}^2)  
{\mathbf{A}}^{(n_f)}(Q_{h}^2) {\mathbf{E}}^{(n_f)}(Q_{h}^2\leftarrow Q^2_0) \rc \otimes {\mathbf{f}}^{(n_f)}(Q^2_0) \, ,
\ee
...
presented in~\citesupp{zanoli} finding also good agreement.
%
...
carried out
following the settings of~\citesupp{Dittmar:2005ed,Giele:2002hx}.
%
...
\begin{figure}[t]
    \begin{center}
        \includegraphics[width=0.47\linewidth]{plots/eko_bench_V.pdf}
        \includegraphics[width=0.47\linewidth]{plots/eko_bench_S.pdf}
...
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=0.49\linewidth]{plots/pch_vs_fitted_forward.pdf}
    \includegraphics[width=0.49\linewidth]{plots/pch_vs_fitted_forward_MHOU.pdf}
...
\begin{figure}[t!]
  \begin{center}
    \includegraphics[width=0.99\linewidth]{plots/pdfplot-abscharm-dataset_dep.pdf}
...
\begin{figure}[t!]
  \begin{center}
    \includegraphics[width=0.60\linewidth]{plots/pdfplot-abscharm-basisdep.pdf}
...
by the Higgs cross-section working group~\citesupp{deFlorian:2016spz}
based on the study of~\citesupp{Bauer:2004ve}, namely
...
\begin{figure}[t]
  \begin{center}
    \includegraphics[width=0.99\linewidth]{plots/pdfplot-abscharm-mcdep.pdf}
...
\begin{figure}[t]
  \begin{center}
    \includegraphics[width=0.99\linewidth]{plots/pdfplot-abscharm-mcdep-highQ.pdf}
...
\begin{figure}[t]
  \begin{center}
    \includegraphics[width=0.65\linewidth]{plots/pdfplot-abscharm-40-vs-31meth.pdf}
...
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=0.49\linewidth]{plots/EMC_Quad_MHOU.pdf}
    \includegraphics[width=0.49\linewidth]{plots/DIS_only_Quad_MHOU.pdf}
    \includegraphics[width=0.49\linewidth]{plots/collider_only_Quad_MHOU.pdf}
    \includegraphics[width=0.49\linewidth]{plots/noLHCb_Quad_MHOU.pdf}
    \includegraphics[width=0.49\linewidth]{plots/noHERA_Quad_MHOU.pdf}
    \includegraphics[width=0.49\linewidth]{plots/noATLASCMSDY_Quad_MHOU.pdf}
    \includegraphics[width=0.49\linewidth]{plots/nojets_Quad_MHOU.pdf}
    \includegraphics[width=0.49\linewidth]{plots/noZpT_Quad_MHOU.pdf}
...
\begin{figure}[t!]
  \begin{center}
    \includegraphics[width=0.54\linewidth]{plots/Flavor_Basis_Quad_MHOU.pdf}
...
\begin{figure}[h]
  \begin{center}
\includegraphics[width=0.49\linewidth]{plots/mass_variations_Quad_MHOU.pdf}
    \includegraphics[width=0.49\linewidth]{plots/mass_variations_ratio_Quad_MHOU.pdf}
\caption{\small      
...
\begin{figure}[h]
  \begin{center}
     \includegraphics[width=0.60\linewidth]{plots/charm_momfrac_qdep.pdf}
    \caption{\small 
...
\begin{figure}[t]
  \begin{center}
    \includegraphics[width=0.49\linewidth]{plots/charm_momfrac_qdep_mc.pdf}
    \includegraphics[width=0.49\linewidth]{plots/charm_momfrac_qdep_mc_pert.pdf}
    \caption{\small
...
\begin{figure}[h!]
  \begin{center}
    \includegraphics[width=0.65\linewidth]{plots/charm_momfrac_xmin_dep_3fns.pdf}
...
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=0.49\linewidth]{plots/pdfplot-abs-lin-charm-q1p65gev.pdf}
    \includegraphics[width=0.49\linewidth]{plots/pdfplot-abscharm-q1p65gev.pdf}    \includegraphics[width=0.49\linewidth]{plots/pdfplot-abscharm-q100gev.pdf}	
    \includegraphics[width=0.49\linewidth]{plots/charm_momfrac_qdep_ct.pdf}
...
with the Monash 2013 tune~\citesupp{Skands:2014pea} for showering,
...
of $R=0.5$~\citesupp{Cacciari:2008gp}.
%
...
\begin{tabularx}{\textwidth}{C{3.5cm}C{2.5cm}C{2.5cm}C{2.5cm}C{2.5cm}}
  \toprule
 \multirow{2}{*}{ $\chi^2/N_{\rm dat}$}  &   \multicolumn{2}{c}{ default charm}   &\multicolumn{2}{c}{perturbative charm} \\
...
through
Bayesian reweighting~\citesupp{Ball:2010gb,Ball:2011gg}. The
...
replicas~\citesupp{Ball:2010gb,Ball:2011gg} after reweighting
...
\be
\label{eq:ic/lumi1D}
\mathcal{L}_{ab}(m_X)= \frac{1}{s}\int_{\tau}^1 \frac{dx}{x}f_a \lp x,m_X^2\rp
...
\be
\label{eq:ic/lumis}
\mathcal{L}_{qg}(m_X)\equiv \sum_{i=1}^{n_f} \lp \mathcal{L}_{q_ig}(m_X)+
\mathcal{L}_{\bar{q}_ig}(m_X) \rp\, , \quad
\mathcal{L}_{cg}(m_X)\equiv  \lp \mathcal{L}_{cg}(m_X)+
\mathcal{L}_{\bar{c}g}(m_X) \rp\, , 
\ee
...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=0.99\linewidth]{plots/cglumi-nnpdf40-ATLAScuts.pdf}
    \includegraphics[width=0.99\linewidth]{plots/cglumi-nnpdf40-LHCbcuts-central.pdf}
    \includegraphics[width=0.99\linewidth]{plots/cglumi-nnpdf40-LHCbcuts-forward.pdf}
...
%\bibliographysupp{nnpdf40charm}
\input{nnpdf40charm.bbl}
