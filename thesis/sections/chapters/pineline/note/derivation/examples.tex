...
\begin{figure}
    \label{fig:9}
    \centering
        $\vcenter{\hbox{\input{sections/chapters/pineline/note/derivation/9}}}$
    \qquad
        $\vcenter{\hbox{\includegraphics[width=0.3\textwidth]{ch-pineline/9-prescription}}}$
    \begin{caption}{
...
\begin{figure}
    \label{fig:5}
    \centering
        $\vcenter{\hbox{\input{sections/chapters/pineline/note/derivation/5}}}$
    \qquad
        $\vcenter{\hbox{\includegraphics[width=0.3\textwidth]{ch-pineline/5-prescription}}}$
    \begin{caption}{
...
\begin{figure}
    \label{fig:5bar}
    \centering
        $\vcenter{\hbox{\input{sections/chapters/pineline/note/derivation/5bar}}}$
    \qquad
        $\vcenter{\hbox{\includegraphics[width=0.3\textwidth]{ch-pineline/5bar-prescription}}}$
    \begin{caption}{
