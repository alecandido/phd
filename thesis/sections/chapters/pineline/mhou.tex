...
\label{sec:intro}
\input{sections/chapters/pineline/note/introduction}

\subsection{Derivation}
\label{sec:deriv}
\input{sections/chapters/pineline/note/derivation}

\subsection{Alternative space: $\kappa_F$ slices}
\label{sec:slices}
\input{sections/chapters/pineline/note/slices}

\subsection{Conclusions}
\label{sec:concl}
\input{sections/chapters/pineline/note/conclusions}
