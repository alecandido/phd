...
\begin{figure}
  \centering
  \includegraphics[width=0.49\linewidth]{plots/symmetric-couplings.pdf}
  \includegraphics[width=0.49\linewidth]{plots/antisymmetric-couplings.pdf}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.49\linewidth]{plots/sigma_grid_ana-MLL_5000_COSTH-r3.pdf}
  \includegraphics[width=0.49\linewidth]{plots/afb_grid_ana-MLL_5000_COSTH-r3.pdf}
  \caption{The single-inclusive differential distribution in
    ...
    %
    One of the replicas of the \nnpdfr{4.0} NNLO PDF set is used as input
    to the calculation.
  }    
...
entering \crefrange{eq:coup}{eq:propzz} set to the values used in
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.49\linewidth]{plots/sigma_grid_ana-MLL_5000_YLL-r3.pdf}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.49\linewidth]{plots/sigma_lo_nlo-MLL_5000_COSTH-r3.pdf}
  \includegraphics[width=0.49\linewidth]{plots/afb_lo_nlo-MLL_5000_COSTH-r3.pdf}
