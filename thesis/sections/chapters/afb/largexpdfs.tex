...
at $\mll=m_Z$ (top)
and $\mll=\SI{5}{\tera\electronvolt}$ (bottom panels).
 }    
...
production, with $\sqrt{s}=\SI{14}{\tera\electronvolt}$,
...
%
But for $\mll=\SI{5}{\tera\electronvolt}$, the smallest value of $x_2$, attained when
...
and at $\mll=\SI{5}{\tera\electronvolt}$.
%
...
\begin{figure}[!t]
 ...
 \caption{\small Comparison of the $xf^+_q$ (top) and $xf_q^-$ (bottom) quark
   ...
   evaluated at $\mll=\SI{5}{\tera\electronvolt}$ for \nnpdfr{4.0} \nnlo.
   %
   ...
   CoM energy $\sqrt{s}=\SI{14}{\tera\electronvolt}$, and the value of $x$
...
compare  the total $xf^+_q$ and valence $xf_q^-$  quark
  ...
  smallest allowed value of $x$ 
   for dilepton DY production with invariant mass $\mll=\SI{5}{\tera\electronvolt}$ for a collider
   CoM energy $\sqrt{s}=\SI{14}{\tera\electronvolt}$.
   %
